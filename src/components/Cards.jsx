        ...
        <div className='container-items'>
          {productosAleatorios.map(product => (
            <div className='item' key={product.id}>
              ...
              <img className='shareImg' src='https://sonidos-reservados.s3.amazonaws.com/imgFront/share.png' onClick={() => openShareButtons(product)} />
                </ShareButtonContainer>
              ...
              <div className='shareButtons'>
                ...
                <textarea value={customMessage} onChange={(e) => setCustomMessage(e.target.value)} placeholder="Escribe tu mensaje personalizado"
                        rows={4} cols={50}
                />
                <img className='IconRedes' src='https://sonidos-reservados.s3.amazonaws.com/imgFront/facebook.png' onClick={() => shareOnFacebook(product.id)} />
                <img className='IconRedes' src='https://sonidos-reservados.s3.amazonaws.com/imgFront/instagram.png' onClick={() => shareOnInstagram(product.id)} />
                <img className='IconRedes' src='https://sonidos-reservados.s3.amazonaws.com/imgFront/whatsapp.png' onClick={() => shareOnWhatsApp(product.id)} />
                <img className='IconRedes' src='https://sonidos-reservados.s3.amazonaws.com/imgFront/twitter.png' onClick={() => shareOnTwitter(product.id)} />
